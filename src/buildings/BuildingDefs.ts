...
export const BUILDING_DEFS: Record<BuildingId, BuildingDef> = {
  stronghold: {
    ...
    buildTime: 0, size: 4, buildRadius: 12, requires: [], produces: ['commander'],
  ...
  generator: {
    ...
    fluxGen: 10, hp: 600, buildTime: 10, size: 3, buildRadius: 10, requires: [], produces: [], hotkey: 'ONE',
  ...
  barracks: {
    ...
    fluxGen: 0, hp: 1000, buildTime: 15, size: 3, buildRadius: 10, requires: ['power'], produces: ['rifleman'],
  ...
  mechanis: {
    ...
    fluxGen: 0, hp: 1200, buildTime: 20, size: 3, buildRadius: 10, requires: ['power', 'infantry'], produces: ['heavy'],
  ...
  turret: {
    ...
    fluxGen: 0, hp: 700, buildTime: 10, size: 2, buildRadius: 6, requires: ['power'], produces: [],
  ...
  relay: {
    ...
    fluxGen: 0, hp: 500, buildTime: 12, size: 2, buildRadius: 16, requires: ['power'], produces: [], hotkey: 'FIVE',
  ...
  research: {
    ...
    fluxGen: 0, hp: 1000, buildTime: 25, size: 3, buildRadius: 10, requires: ['power', 'infantry'], produces: [],
  ...
  spine: {
    ...
    fluxGen: 0, hp: 650, buildTime: 10, size: 2, buildRadius: 6, requires: ['power'], produces: [],
