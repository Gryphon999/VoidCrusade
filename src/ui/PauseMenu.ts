...
export class PauseMenu {
  ...
  open(): void {
    ...
    const title = this.scene.add.text(cx, cy - 105, 'Paused', { fontFamily: GOTHIC_FONT, fontSize: '48px', color: '#ffd060' }).setOrigin(0.5);
    ...
    const items: [string, () => void][] = [
      ...
      [campaign ? 'Retreat to Campaign' : 'Quit to Menu', () => this.quit(campaign)],
    ];
